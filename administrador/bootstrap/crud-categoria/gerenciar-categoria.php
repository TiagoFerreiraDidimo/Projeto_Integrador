                    ...
                    <div class="col-md-12">
                        <div class="table-responsive ">
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                $select = $con->prepare("SELECT * FROM  easy_categoria ");
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['titulo_cat']; ?></td>

                                    <td><a  href="delete.php?inst_id=<?php echo $data['id']; ?>">deletar</a></td>
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                $con = new PDO ("mysql:host=localhost;dbname=easy_donation","root","");
                                $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                $select = $con->prepare("SELECT * FROM  easy_subcategoria ");
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['titulo_sub']; ?></td>
